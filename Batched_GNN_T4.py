...
class GNNClassifier(torch.nn.Module):
    def __init__(self, num_classes, global_graph):
        ...
        self.conv1 = GATv2Conv(L0_SIZE, L1_SIZE, add_self_loops = False, edge_dim = EMBED_SIZE, dropout = 0.3)
        self.conv2 = GATv2Conv(L1_SIZE, L2_SIZE, add_self_loops = False, edge_dim = EMBED_SIZE, dropout = 0.3)
        self.conv3 = GATv2Conv(L2_SIZE, L3_SIZE, add_self_loops = False, edge_dim = EMBED_SIZE, dropout = 0.3)
    ...
    def forward(self, climbs):
        ...
        ### MAYBE A LINEAR LAYER HERE??
        ### THEN DROPOUT WOULD BE AFTER THE LINEAR LAYER
        x  = F.dropout(x, p = 0.2)
        # [B, N, 213] -> [B, N, 64]
